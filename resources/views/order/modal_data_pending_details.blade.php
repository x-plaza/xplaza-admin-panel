...
<div class="row" style="margin-bottom: 10px;">
  <div class="col-md-12" >
    <a href="javascript:void(0)" class="list-group-item AddToInvoice">Customer Name <b
              style="float: right;color: red;">{{$orderDetailsData->customer_name}}</b></a>
    <a href="javascript:void(0)" class="list-group-item AddToInvoice">Delivery Address <b
              style="float: right;color: red;">{{$orderDetailsData->delivery_address}}</b></a>
    <a href="javascript:void(0)" class="list-group-item AddToInvoice">Customer Mobile <b
              style="float: right;color: red;">{{$orderDetailsData->mobile_no}}</b></a>
    <a href="javascript:void(0)" class="list-group-item AddToInvoice">Delivery Man <b
              style="float: right;color: red;">{{$orderDetailsData->delivery_person}}</b></a>
    <a href="javascript:void(0)" class="list-group-item AddToInvoice">Delivery Man Mob <b
              style="float: right;color: red;">{{$orderDetailsData->contact_no}}</b></a>
  </div>
</div>
