    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Product Verient Type List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">PVT</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="pvt_name" type="text" class="form-control pvt_name" placeholder="Enter Name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Description</label>
                        <textarea name="pvt_description" class="form-control pvt_description"></textarea>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary store_new_pvt"> <span class="spinner-icon"></span> Save </button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" id="edit-modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary update_pvt"> <span class="spinner-icon"></span> Update </button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
@section('scripts')
    ...
    <script language="javascript">
        ...
        $(document).ready(function() {
            ...
            function getPVTList() {
                $('#pvt_list').DataTable({
                    ...
                    ajax: {
                        ...
                        url: '{{url("product-var-type/get-list")}}',
                        method: 'post'
                    },
                    columns: [
            ...
            $(document).on('click', '.store_new_pvt', function () {
                $('.add_response_msg_area').empty();
                var pvt_name = $('.pvt_name').val();
                var pvt_description = $('.pvt_description').val();
                ...
                $.ajax({
                    url: '{{ url('/product-var-type/add-new-pvt') }}',
                    type: "POST",
                    //dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    ...
                    success: function (response) {
                        ...
                        if (response.responseCode == 1) {
                            ...
                            var dataTable = $('#pvt_list').dataTable();
                            dataTable.fnDestroy();
                            getPVTList();
            ...
            $(document).on('click', '.open_pvt_modal', function () {

                var pvt_id = jQuery(this).data('pvt_id');
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ url('/product-var-type/get-pvt-info') }}",
                    data: {
            ...
            $(document).on('click', '.update_pvt', function () {
                $('.edit_response_msg_area').empty();
                var edit_pvt_id = $('.edit_pvt_id').val();
                var edit_pvt_name = $('.edit_pvt_name').val();
                var edit_pvt_description = $('.edit_pvt_description').val();

                if (edit_pvt_name == '') {
                    alert("please insert name");
                    return false;
                }
                if (edit_pvt_description == '') {
                    alert("please insert description");
                    return false;
                }
                ...
                $.ajax({
                    url: '{{ url('/product-var-type/update-pvt') }}',
                    type: "POST",
                    //dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    ...
                    data: {
                        pvt_id: edit_pvt_id,
                        pvt_name: edit_pvt_name,
                        pvt_description: edit_pvt_description
                    },
                    success: function (response) {
                        btn.prop('disabled', false);
                        $('.spinner-icon').empty();
            ...
            $(document).on('click', '.deletePVT', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ url('/product-var-type/delete-pvt') }}",
                    data: {
                        _token: $('input[name="_token"]').val(),
                        pvt_id: pvt_id
                    },
