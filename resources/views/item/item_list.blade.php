                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-10 text-center">
                            <div id="image_demo" class="image_demo" style="width:350px; margin-top:30px"></div>
                        </div>
    ...
    <script language="javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.update_item', function () {
                ...
                var item_image_exist = $('.edit_image_name_exist').val();
                var item_image_id = $('.edit_image_id').val();
                var edit_image_base64_hidden = $('.edit_image_base64_hidden').val();
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        quantity: quantity,
                        product_var_type_id: product_var_type_id,
                        item_image_exist: item_image_exist,
                        item_image_id: item_image_id,
                        edit_image_base64_hidden: edit_image_base64_hidden,
                        product_var_type_value: product_var_type_value
                    },
                    success: function (response) {
                        btn.prop('disabled', false);
