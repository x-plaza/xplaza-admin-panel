...
class pvtController extends Controller
{
    ...
    public function getList()
    {
        ...
        $api_url = env('API_BASE_URL','https://xplaza-backend.herokuapp.com')."/api/prodvartype";
    ...
    public function store(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL','https://xplaza-backend.herokuapp.com')."/api/prodvartype/add";
    ...
    public function pvtInfo(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL','https://xplaza-backend.herokuapp.com')."/api/prodvartype/".intval($pvt_id);
        $curlOutput  = HandleApi::getCURLOutput( $api_url, 'GET', [] );
    ...
    public function updatePVT(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL','https://xplaza-backend.herokuapp.com')."/api/prodvartype/update";
    ...
    public function deletePVT(Request $request)
    {
        ...
        $api_url = env('API_BASE_URL','https://xplaza-backend.herokuapp.com')."/api/prodvartype/".intval($request->get('pvt_id'));
