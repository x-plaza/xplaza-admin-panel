...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $api_url = "https://xplaza-backend.herokuapp.com/api/category/add";
    ...
    public function categoryInfo(Request $request)
    {
        ...
        $api_url = "https://xplaza-backend.herokuapp.com/api/category/".intval($category_id);
        $curlOutput  = HandleApi::getCURLOutput( $api_url, 'GET', [] );
        $decodedData = json_decode($curlOutput);
    ...
    public function updateCategory(Request $request)
    {
        ...
        $api_url = "https://xplaza-backend.herokuapp.com/api/category/update";
    ...
    public function deleteCategory(Request $request)
    {
        ...
        $api_url = "https://xplaza-backend.herokuapp.com/api/category/".intval($request->get('category_id'));
